...
| [`ANALIZA-REJESTRACJA.md`](ANALIZA-REJESTRACJA.md) | Analiza UX ekranu rejestracji: 7 usterek krytycznych, 6 wysokiego wpływu, 12 średnich, kolejność wdrożenia, niespójności kontaktowe w serwisie. |
| [`rejestracja/index.html`](rejestracja/index.html) | Prototyp przebudowanego ekranu rejestracji z przełącznikiem „Pokaż uwagi UX". Działające: weryfikacja sumy kontrolnej NIP, lista krajów sortowana po polsku z filtrowaniem, trzy kroki, żywa walidacja hasła, rozdzielone zgody. |
